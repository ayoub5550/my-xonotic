// Diffuse texture x baked lightmap (uv2), with vertex-colour fallback, plus
// dev.18: fullbright glow layer (DarkPlaces *_glow convention) and tcMod scroll.
// Mobile-oriented: one texture fetch + one lightmap fetch (+ glow), no dynamic lights.
