// dev.18: additive variant of MyXonotic/Lightmapped for Q3 stages with
// "blendfunc add" / GL_ONE GL_ONE on their base stage (light beams, glow-only
// panels, energy fields): colour adds onto what is behind, no depth write.
Shader "MyXonotic/LightmappedAdd"
{
    Properties
    {
