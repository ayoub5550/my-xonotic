# أرشيف التسليم السابق — لا تستخدمه كحالة جارية

حُفظ النص السابق أدناه دون إعادة تفسير نتائجه. مرجع المتابعة الجاري هو
[AGENTS.md](../../AGENTS.md) في جذر المشروع؛ أوصاف «Current» داخل هذا الأرشيف
تاريخية، وجميع المسارات في النص المحفوظ نسبية إلى جذر المستودع لا مجلد الأرشيف.
